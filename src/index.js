    ...
    jasperclient.prototype._request = function (method,path,params,data,opt) {
        return new Promise( (resolve,reject) => {
            if ( this.useBasicAuth ) {
                ...
                if ( this.useBasicAuth && !opt.headers.Authorization ) opt.headers.Authorization = 'Basic '+Base64.encode( this.username+':'+this.password );
            }
            ...
            .then( async response => {
                ...
                if ( response.status == 302 ) {
                    ...
                    for ( let str of header ) {
                        ...
                        if ( c ) await this.cookiejar.setCookie(c,this.baseURL);
                    }
